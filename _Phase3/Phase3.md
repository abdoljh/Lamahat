...
> `resources/script/al_askari_script.txt` (Phase 1b output) and
> `resources/audio/al_askari_audio.mp3` + `resources/audio/al_askari_music.mp3`.
...
> **Canonical render notebook**: `_phase3_render_only_7.ipynb`.
...
├── _phase3_render_only_7.ipynb  # ★ canonical Colab render notebook
├── resources/                # committed project inputs
│   ├── script/               #   al_askari_script.txt  (Phase 1b output)
│   ├── audio/                #   al_askari_audio.mp3 (ElevenLabs v3) + _music.mp3
...
`resources/script/al_askari_script.txt`, `resources/audio/al_askari_audio.mp3`
(ElevenLabs v3 narration), `resources/audio/al_askari_music.mp3` (score bed),
...
The Colab notebook `_phase3_render_only_7.ipynb` exposes these as a single
